<p align="center">
  <img src="https://img.shields.io/badge/Adoback-macOS%20Adobe%20备份守护-8B5CF6?style=for-the-badge&logo=apple&logoColor=white" alt="Adoback">
</p>

<p align="center">
  <strong>PS 闪退、PR 崩溃、文件被覆盖？装个兜底的。</strong>
</p>
...
<p align="center">
  ...
  <a href="https://github.com/SOULRAi/adoback/releases"><img src="https://img.shields.io/github/v/release/SOULRAi/adoback?color=8B5CF6&logo=github" alt="release"></a>
  <img src="https://img.shields.io/badge/platform-macOS-lightgrey?logo=apple" alt="macOS">
  <img src="https://img.shields.io/badge/license-MIT-green" alt="MIT">
  <img src="https://img.shields.io/badge/lang-中文优先-orange" alt="中文">
</p>

<p align="center">
  在 Adobe 之外建立一层<b>独立、可控、可长期运行的备份系统</b><br>
  一行安装，开机自动跑，装完就不用管了
</p>
...
| 👁️ | **实时监听** | `watch` 基于 FSEvents，文件保存秒级触发备份 |
| 📊 | **状态面板** | `status` TUI 仪表盘，一览备份全局 |
...
adoback doctor                         # 自检
adoback backup --dry-run               # 试运行（不复制）
...
| `performance.verify` | `mtime_size` | 校验：`none` / `mtime_size` / `sha256` |
...
- ⚠️ **无法备份 Adobe 内存中未保存的内容** — 这是所有外部备份工具的天然边界
- 不替代 Adobe 自身的自动保存，而是在其之外多一层兜底
- 不保证 100% 零丢失，但能大幅降低风险

---

<p align="center">
  <sub>Made with ☕ for designers who lost files one too many times</sub>
</p>
